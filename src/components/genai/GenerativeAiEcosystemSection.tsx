...
import { ecosystemNodes } from "./ecosystemData";
...
export default function GenerativeAiEcosystemSection() {
  return (
      ...
      <Container className="relative z-10">
        <div className="mx-auto max-w-2xl text-center">
          ...
          <h2 className="mt-3 text-3xl font-semibold tracking-tight text-slate-900 sm:text-4xl">
            One enterprise AI core, nine connected capabilities
          </h2>
        </div>
        ...
        <div className="mt-12 lg:hidden">
          <IconGrid
            items={ecosystemNodes.map((node) => ({ icon: node.icon, title: node.label }))}
