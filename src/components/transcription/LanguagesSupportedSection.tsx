...
import { internationalLanguages, indianLanguages } from "./transcriptionLanguagesData";

export default function LanguagesSupportedSection() {
  return (
      ...
      <Container className="relative z-10">
        <div className="mx-auto max-w-2xl text-center">
          ...
          <h2 className="mt-3 text-3xl font-semibold tracking-tight text-slate-900 sm:text-4xl">
            Fifty-plus languages. Every accent, every domain.
          </h2>
