...
export const caseStudies: CaseStudy[] = [
  {
    ...
    title: "Scaling AI Data Annotation for a Computer Vision Project ",
    shortDescription:
    ...
    client: "Global AI Technology Company",
    duration: "5 months",
    overview:
      "The client needed a large volume of accurately annotated image datasets to train a computer vision model. Internal resources were insufficient to meet aggressive delivery timelines. ",
    challenge:
      "The client needed a large volume of accurately annotated image datasets to train a computer vision model. Internal resources were insufficient to meet aggressive delivery timelines. ",
    challenges: [
      "Aggressive delivery timeline outpaced internal annotation capacity",
      "Radiology-grade accuracy required on every labeled study",
      "PHI-sensitive DICOM data demanded strict de-identification",
      "No existing multi-tier QA process for clinical-grade validation",
    ],
    solution:
    ...
    toolsUsed: ["CVAT", "OHIF Viewer", "pydicom", "Python"],
  ...
  },
  {
    ...
    challenges: [
      "Annotation throughput couldn't match test-fleet data volume",
      "Inconsistent camera-to-LiDAR label alignment across vendors",
      "No process for surfacing safety-critical edge cases",
      "Manual review couldn't scale to millions of frames",
    ],
    solution:
  ...
  },
  {
    ...
    challenges: [
      "Inconsistent seller-submitted product imagery",
      "Fragmented taxonomy causing frequent mis-categorization",
      "Search relevance suffering from inaccurate tagging",
      "Slow time-to-list for new inventory",
    ],
    solution:
  ...
  },
  {
    ...
    challenges: [
      "Inconsistent OCR quality across scanned statements",
      "Compliance team couldn't scale manual labeling",
      "Insufficient labeled examples of known fraud typologies",
      "Production-grade accuracy required before model deployment",
    ],
    solution:
  ...
  },
  {
    ...
    challenges: [
      "Satellite and drone imagery at mismatched resolutions",
      "Inconsistent revisit rates across imagery sources",
      "Agronomists couldn't scale review across every region",
      "Field-level labeling consistency was difficult to maintain",
    ],
    solution:
  ...
  },
  {
    ...
    challenges: [
      "Footage volume from hundreds of intersections outpaced review capacity",
      "Existing labels lacked temporal consistency for tracking",
      "No unified taxonomy for incident-event tagging",
      "Manual review couldn't keep up with live camera feeds",
    ],
    solution:
