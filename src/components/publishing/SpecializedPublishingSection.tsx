...
import { specializedPublishingPillars } from "./specializedPublishingData";

export default function SpecializedPublishingSection() {
  return (
      ...
      <Container className="relative z-10">
        <div className="mx-auto max-w-2xl text-center">
          ...
          <h2 className="mt-3 text-3xl font-semibold tracking-tight text-slate-900 sm:text-4xl">
            Depth in the domains that need it most
          </h2>
        </div>

        <div className="mx-auto mt-12 grid max-w-5xl grid-cols-1 gap-6 sm:grid-cols-3">
          {specializedPublishingPillars.map((pillar) => (
