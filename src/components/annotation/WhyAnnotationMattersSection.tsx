...
import { impactNodes, annotationBenefits } from "./whyAnnotationData";
...
export default function WhyAnnotationMattersSection() {
  return (
    <section className="relative w-full overflow-hidden py-16 lg:py-20">
      ...
      <Container className="relative z-10">
        ...
        <div className="relative mx-auto mt-16 hidden aspect-square max-w-[560px] lg:block">
          <div aria-hidden className="absolute inset-[24%] rounded-full border border-slate-100" />
        ...
        <div className="mt-12 lg:hidden">
          <IconGrid
            items={impactNodes.map((node) => ({ icon: node.icon, title: node.label }))}
        ...
        <div className="mx-auto mt-14 max-w-5xl">
          <IconGrid items={annotationBenefits} columnsClassName="grid-cols-1 sm:grid-cols-2 lg:grid-cols-3" />
        </div>
      </Container>
    </section>
  );
