...
import { diversityDimensions, internationalLanguages, indianLanguages } from "./accentsData";
import SectionBackdrop from "@/components/servicePage/SectionBackdrop";

export default function AccentsLanguagesSection() {
  return (
      ...
      <Container className="relative z-10">
        <div className="mx-auto max-w-2xl text-center">
          ...
          <h2 className="mt-3 text-3xl font-semibold tracking-tight text-slate-900 sm:text-4xl">
            Every accent, every region, every voice
          </h2>
        ...
        <div className="mx-auto mt-10 max-w-3xl">
          <ChipList items={diversityDimensions} className="justify-center" />
        </div>
