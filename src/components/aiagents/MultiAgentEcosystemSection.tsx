...
import { orchestrationNodes } from "./multiAgentData";
...
export default function MultiAgentEcosystemSection() {
  return (
      ...
      <Container className="relative z-10">
        <div className="mx-auto max-w-2xl text-center">
          ...
          <h2 className="mt-3 text-3xl font-semibold tracking-tight text-slate-900 sm:text-4xl">
            Specialized agents, coordinated by one orchestrator
          </h2>
        </div>
        ...
        <div className="mt-12 lg:hidden">
          <IconGrid
            items={orchestrationNodes.map((node) => ({ icon: node.icon, title: node.label }))}
