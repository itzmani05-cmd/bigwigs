    ...
    <section className="relative w-full overflow-hidden py-16 lg:py-20">
      ...
      <Container className="relative z-10">
        <div className="grid grid-cols-1 items-center gap-14 lg:grid-cols-[46%_54%] lg:gap-12">
          {/* LEFT — flat AI operations dashboard mockup */}
          <div className="mx-auto w-full max-w-[440px] overflow-hidden rounded-2xl border border-slate-200 bg-white">
            <div className="flex items-center justify-between border-b border-slate-100 px-4 py-3">
              <span className="flex items-center gap-1.5 text-[10px] font-semibold uppercase tracking-wide text-slate-400">
                <Bot size={12} className="text-brand-blue-500" />
            ...
            <div className="grid grid-cols-3 gap-px bg-slate-100">
              {["70% Automated", "80% Faster", "Millions Processed"].map((label) => (
          ...
          <div>
            ...
            <h2 className="mt-3 text-3xl font-semibold tracking-tight text-slate-900 sm:text-4xl">
              Helping enterprises automate intelligent workflows
            </h2>
            <p className="mt-4 max-w-lg text-base leading-relaxed text-slate-500">
              An enterprise team partnered with Bigwigs to deploy a multi-agent system across
              customer service, finance, and operations — automating the majority of routine
              requests within one quarter.
            </p>
