          ...
          {stats.map((stat, i) => {
            ...
            return (
              <motion.div
                ...
                className="flex flex-col items-center rounded-[24px] border border-slate-200/70 bg-white p-6 text-center shadow-[0_16px_40px_-30px_rgba(15,23,42,0.2)] transition-all duration-300 hover:-translate-y-1.5 sm:p-8"
              >
                <span className="flex h-12 w-12 items-center justify-center rounded-full bg-brand-blue-50 text-brand-blue-500">
                  <Icon size={22} strokeWidth={1.75} />
                </span>
                <span className="mt-4 text-3xl font-extrabold tracking-tight text-slate-900 sm:text-4xl">
